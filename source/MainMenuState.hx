	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					FlxG.openURL('https://www.youtube.com/c/GameTheorists/');
					FlxG.openURL('https://www.youtube.com/user/FilmTheorists');
					FlxG.openURL('https://www.youtube.com/channel/UCHYoe8kQ-7Gn9ASOlmI0k6Q');
					FlxG.openURL('https://www.youtube.com/channel/UCAaegDUlb7doIKo0Rc1F08g');
				}
					...
					menuItems.forEach(function(spr:FlxSprite)
					{
						...
						else
						{
							FlxFlicker.flicker(spr, 1, 0.06, false, false, function(flick:FlxFlicker)
							{
								...
								{
									case 'story mode':
										PlayState.storyPlaylist = ['Science-Blaster'];
										...
										FlxG.sound.music.stop();
										FlxG.switchState(new VideoState('assets/videos/cutscene.webm',function(){FlxG.switchState(new PlayState());}, 24, false));
